...
newtype RoleAdminChanged = RoleAdminChanged {role :: (BytesN (D3 :& DOne D2)),previousAdminRole :: (BytesN (D3 :& DOne D2)),newAdminRole :: (BytesN (D3 :& DOne D2))}
...
instance eventFilterRoleAdminChanged :: EventFilter RoleAdminChanged where
  eventFilter _ addr = defaultFilter
    # _address .~ Just addr
    # _topics .~ Just [Just ( unsafePartial $ fromJust $ mkHexString "bd79b86ffe0ab8e8776151514217cd7cacd52c909f66475c3af44e129f0b00ff"),Nothing,Nothing,Nothing]
...
newtype RoleGranted = RoleGranted {role :: (BytesN (D3 :& DOne D2)),account :: Address,sender :: Address}
...
instance eventFilterRoleGranted :: EventFilter RoleGranted where
  eventFilter _ addr = defaultFilter
    # _address .~ Just addr
    # _topics .~ Just [Just ( unsafePartial $ fromJust $ mkHexString "2f8788117e7eff1d82e926ec794901d17c78024a50270940304540a733656f0d"),Nothing,Nothing,Nothing]
...
newtype RoleRevoked = RoleRevoked {role :: (BytesN (D3 :& DOne D2)),account :: Address,sender :: Address}
...
instance eventFilterRoleRevoked :: EventFilter RoleRevoked where
  eventFilter _ addr = defaultFilter
    # _address .~ Just addr
    # _topics .~ Just [Just ( unsafePartial $ fromJust $ mkHexString "f6391f5c32d9c69d2a47ea670b442974b53935d1edc7fd64eb21e047a839171b"),Nothing,Nothing,Nothing]
...
type DEFAULT_ADMIN_ROLEFn = Tagged (SProxy "DEFAULT_ADMIN_ROLE()") (Tuple0 )
...
type TOKEN_MARK_ROLEFn = Tagged (SProxy "TOKEN_MARK_ROLE()") (Tuple0 )
...
type GetRoleAdminFn = Tagged (SProxy "getRoleAdmin(bytes32)") (Tuple1 (Tagged (SProxy "role") (BytesN (D3 :& DOne D2))))
...
type GetRoleMemberFn = Tagged (SProxy "getRoleMember(bytes32,uint256)") (Tuple2 (Tagged (SProxy "role") (BytesN (D3 :& DOne D2))) (Tagged (SProxy "index") (UIntN (D2 :& D5 :& DOne D6))))
...
type GetRoleMemberCountFn = Tagged (SProxy "getRoleMemberCount(bytes32)") (Tuple1 (Tagged (SProxy "role") (BytesN (D3 :& DOne D2))))
...
type GrantMarketplaceAccessFn = Tagged (SProxy "grantMarketplaceAccess(address)") (Tuple1 (Tagged (SProxy "_account") Address))
...
type GrantRoleFn = Tagged (SProxy "grantRole(bytes32,address)") (Tuple2 (Tagged (SProxy "role") (BytesN (D3 :& DOne D2))) (Tagged (SProxy "account") Address))
...
type HasRoleFn = Tagged (SProxy "hasRole(bytes32,address)") (Tuple2 (Tagged (SProxy "role") (BytesN (D3 :& DOne D2))) (Tagged (SProxy "account") Address))
...
type RenounceRoleFn = Tagged (SProxy "renounceRole(bytes32,address)") (Tuple2 (Tagged (SProxy "role") (BytesN (D3 :& DOne D2))) (Tagged (SProxy "account") Address))
...
type RevokeRoleFn = Tagged (SProxy "revokeRole(bytes32,address)") (Tuple2 (Tagged (SProxy "role") (BytesN (D3 :& DOne D2))) (Tagged (SProxy "account") Address))
...
type SetERC721ContractPrimarySaleFeePercentageFn = Tagged (SProxy "setERC721ContractPrimarySaleFeePercentage(address,uint8)") (Tuple2 (Tagged (SProxy "_contractAddress") Address) (Tagged (SProxy "_percentage") (UIntN (DOne D8))))
...
type SetMarketplaceFeePercentageFn = Tagged (SProxy "setMarketplaceFeePercentage(uint8)") (Tuple1 (Tagged (SProxy "_percentage") (UIntN (DOne D8))))
...
type SetMarketplaceMaxValueFn = Tagged (SProxy "setMarketplaceMaxValue(uint256)") (Tuple1 (Tagged (SProxy "_maxValue") (UIntN (D2 :& D5 :& DOne D6))))
...
type SetMarketplaceMinValueFn = Tagged (SProxy "setMarketplaceMinValue(uint256)") (Tuple1 (Tagged (SProxy "_minValue") (UIntN (D2 :& D5 :& DOne D6))))

--------------------------------------------------------------------------------
-- | ERC20MintableMetadata
--------------------------------------------------------------------------------

module Contracts.V4.ERC20MintableMetadata where
...
type ConstructorFn = Tagged (SProxy "constructor(string,string,uint8,string)") (Tuple4 (Tagged (SProxy "name") String) (Tagged (SProxy "symbol") String) (Tagged (SProxy "decimals") (UIntN (DOne D8))) (Tagged (SProxy "uri") String))

constructor :: TransactionOptions NoPay -> HexString -> { name :: String, symbol :: String, decimals :: (UIntN (DOne D8)), uri :: String } -> Web3 HexString
constructor x0 bc r = uncurryFields  r $ constructor' x0 bc
   where
    constructor' :: TransactionOptions NoPay -> HexString -> (Tagged (SProxy "name") String) -> (Tagged (SProxy "symbol") String) -> (Tagged (SProxy "decimals") (UIntN (DOne D8))) -> (Tagged (SProxy "uri") String) -> Web3 HexString

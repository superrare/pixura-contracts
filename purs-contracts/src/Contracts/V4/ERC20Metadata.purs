...
module Contracts.V4.ERC20Metadata where
...
type ConstructorFn = Tagged (SProxy "constructor(string)") (Tuple1 (Tagged (SProxy "uri") String))

constructor :: TransactionOptions NoPay -> HexString -> { uri :: String } -> Web3 HexString
constructor x0 bc r = uncurryFields  r $ constructor' x0 bc
   where
    constructor' :: TransactionOptions NoPay -> HexString -> (Tagged (SProxy "uri") String) -> Web3 HexString

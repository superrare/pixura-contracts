...
module Contracts.V4.PixuraNFT where
...
type ConstructorFn = Tagged (SProxy "constructor(string,string,address,uint256)") (Tuple4 (Tagged (SProxy "_name") String) (Tagged (SProxy "_symbol") String) (Tagged (SProxy "_operator") Address) (Tagged (SProxy "_operationCost") (UIntN (D2 :& D5 :& DOne D6))))

constructor :: TransactionOptions NoPay -> HexString -> { _name :: String, _symbol :: String, _operator :: Address, _operationCost :: (UIntN (D2 :& D5 :& DOne D6)) } -> Web3 HexString
constructor x0 bc r = uncurryFields  r $ constructor' x0 bc
   where
    constructor' :: TransactionOptions NoPay -> HexString -> (Tagged (SProxy "_name") String) -> (Tagged (SProxy "_symbol") String) -> (Tagged (SProxy "_operator") Address) -> (Tagged (SProxy "_operationCost") (UIntN (D2 :& D5 :& DOne D6))) -> Web3 HexString
...
newtype TokenOwnerURISet = TokenOwnerURISet {_tokenId :: (UIntN (D2 :& D5 :& DOne D6)),_owner :: Address,_uri :: String}

derive instance newtypeTokenOwnerURISet :: Newtype TokenOwnerURISet _

instance eventFilterTokenOwnerURISet :: EventFilter TokenOwnerURISet where
  eventFilter _ addr = defaultFilter
    # _address .~ Just addr
    # _topics .~ Just [Just ( unsafePartial $ fromJust $ mkHexString "8a8b453e9bcfb39debba2c5ddcc97d3d9daf4c65ec6b5f9626c5ea6da3db4a5d"),Nothing,Nothing]

instance indexedEventTokenOwnerURISet :: IndexedEvent (Tuple2 (Tagged (SProxy "_tokenId") (UIntN (D2 :& D5 :& DOne D6))) (Tagged (SProxy "_owner") Address)) (Tuple1 (Tagged (SProxy "_uri") String)) TokenOwnerURISet where
  isAnonymous _ = false

derive instance genericTokenOwnerURISet :: Generic TokenOwnerURISet _

instance eventGenericTokenOwnerURISetShow :: Show TokenOwnerURISet where
  show = genericShow

instance eventGenericTokenOwnerURISeteq :: Eq TokenOwnerURISet where
  eq = genericEq
...
addNewToken :: TransactionOptions MinorUnit -> { _uri :: String } -> Web3 HexString
addNewToken x0 r = uncurryFields  r $ addNewToken' x0
   where
    addNewToken' :: TransactionOptions MinorUnit -> (Tagged (SProxy "_uri") String) -> Web3 HexString
...
type TokenOwnerURIFn = Tagged (SProxy "tokenOwnerURI(uint256)") (Tuple1 (Tagged (SProxy "_tokenId") (UIntN (D2 :& D5 :& DOne D6))))

tokenOwnerURI :: TransactionOptions NoPay -> ChainCursor -> { _tokenId :: (UIntN (D2 :& D5 :& DOne D6)) } -> Web3 (Either CallError String)
tokenOwnerURI x0 cm r = uncurryFields  r $ tokenOwnerURI' x0 cm
   where
    tokenOwnerURI' :: TransactionOptions NoPay -> ChainCursor -> (Tagged (SProxy "_tokenId") (UIntN (D2 :& D5 :& DOne D6))) -> Web3 (Either CallError String)
    tokenOwnerURI' y0 cm' y2 = map unTuple1 <$> call y0 cm' ((tagged $ Tuple1 y2) :: TokenOwnerURIFn)
...
--------------------------------------------------------------------------------
-- | UpdateTokenOwnerMetadataFn
--------------------------------------------------------------------------------


type UpdateTokenOwnerMetadataFn = Tagged (SProxy "updateTokenOwnerMetadata(uint256,string)") (Tuple2 (Tagged (SProxy "_tokenId") (UIntN (D2 :& D5 :& DOne D6))) (Tagged (SProxy "_uri") String))

updateTokenOwnerMetadata :: TransactionOptions NoPay -> { _tokenId :: (UIntN (D2 :& D5 :& DOne D6)), _uri :: String } -> Web3 HexString
updateTokenOwnerMetadata x0 r = uncurryFields  r $ updateTokenOwnerMetadata' x0
   where
    updateTokenOwnerMetadata' :: TransactionOptions NoPay -> (Tagged (SProxy "_tokenId") (UIntN (D2 :& D5 :& DOne D6))) -> (Tagged (SProxy "_uri") String) -> Web3 HexString
    updateTokenOwnerMetadata' y0 y1 y2 = sendTx y0 ((tagged $ Tuple2 y1 y2) :: UpdateTokenOwnerMetadataFn)
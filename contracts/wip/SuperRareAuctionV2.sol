...
contract SuperRareAuctionV2 is Ownable {
  using SafeMath for uint256;

  /////////////////////////////////////////////////////////////////////////
  // State Variables
  /////////////////////////////////////////////////////////////////////////
  // Mapping of ERC721 contract to mapping of token ID to mapping of bidder to bid amount.
  mapping (address => mapping (uint256 => mapping (address => uint256))) private tokenCurrentBids;

  // Mapping of ERC721 contract to mapping of token ID to an ordered array of current bidders. Ordered by highest bid to lowest
